...
Naively keeping the first *K* channels is suboptimal. We want to keep the channels that contain the most information. We compute the importance of each input channel based on the L₂ norm of its weights, sort the channels, and keep the top ones:
